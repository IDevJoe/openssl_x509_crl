...
class X509_CRL
{
	...
	static function create($ci, $ca_pkey, $ca_cert, $crlDistPoint = null) {
		...
		$algs_hash = array( /*OPENSSL_ALGO_DSS1, */OPENSSL_ALGO_SHA1, OPENSSL_ALGO_MD5, OPENSSL_ALGO_MD4, OPENSSL_ALGO_SHA256, OPENSSL_ALGO_SHA384, OPENSSL_ALGO_SHA512, OPENSSL_ALGO_SHA224 );
		...
		if($crl_version == 2) {
            ...
            if($crlDistPoint != null) {
                ...
                $_crl_val->content[0] = new ASN1_SEQUENCE;
                $_crl_val->content[0]->content[0] = new ASN1_SIMPLE;
                $crl_val_0 = & $_crl_val->content[0]->content[0];
                $crl_val_0->setType(0, true, ASN1_CLASSTYPE_CONTEXT);
